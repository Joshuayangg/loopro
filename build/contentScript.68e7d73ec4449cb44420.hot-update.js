  ...
  chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    ...
    switch (message.type) {
      case "startLoop":
        ...
        speed = message.speed; // Add listener to video

        video.addEventListener("timeupdate", loop); // Set speed

        video.playbackRate = speed; // start video at startTime
...
(function () {
  ...
  reactHotLoader.register(speed, "speed", "/Users/joshuayang/Desktop/Github/loopro/src/pages/Content/index.js");
})();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("789e30bd05e6206a676d")
/******/ 	})();
/******/ 	
/******/ }
);
//# sourceMappingURL=contentScript.68e7d73ec4449cb44420.hot-update.js.map